 ...
 */
AFRAME.registerComponent('anime', {
  schema: {
    delay: {default: 0},
    dir: {default: ''},
    dur: {default: 1000},
  ...
  init: function () {
    ...
    this.reverseAnimationBound = this.reverseAnimation.bind(this);
  },
  ...
  reverseAnimation: function() {
    var el = this.el;
    this.animationIsPlaying = true;
    el.emit('animationreverse');
    el.emit(this.attrName + '-reverse');
  ...
  restartAnimation: function () {
    var el = this.el;
    this.animationIsPlaying = true;
    el.emit('animationrestart');
    el.emit(this.attrName + '-restart');
  ...
  addEventListeners: function () {
    ...
    data.reverseEvents.map(function (eventName) {
      el.addEventListener(eventName, self.reverseAnimationBound);
    });
  },
  ...
  removeEventListeners: function () {
    ...
    data.reverseEvents.map(function (eventName) {
      el.removeEventListener(eventName, self.reverseAnimationBound);
    });
  }
});
